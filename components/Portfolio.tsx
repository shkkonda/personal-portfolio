const projects = [
  {
    ...
    desc: "An AI-powered recommendation engine that helps developers choose the right agentic AI framework for their project. Built with Streamlit and Gemini.",
    tags: ["Python", "Streamlit", "Gemini AI"],
  },
  {
    title: "Solana Portfolio Tracker",
    desc: "A tool for checking portfolio value on the Solana blockchain. Enter a wallet\u2019s public key and get a real-time breakdown of holdings.",
    tags: ["Solana", "Python", "Web3"],
  },
  {
    title: "Tax Comparator Tool",
    desc: "Compare tax liability under 44ADA (freelancer) vs salaried employment under India\u2019s new tax regime. Built for professionals exploring contract work.",
    tags: ["Streamlit", "Finance", "India Tax"],
  },
  {
    title: "Overture Maps POI Explorer",
    desc: "Commercial product exploration built on Overture Maps Foundation POI data. Geospatial data visualization and analysis for location intelligence.",
